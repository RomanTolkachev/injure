...
export const Hero: FunctionComponent = () => {
  return (
    <div className="my-gradient h-[calc(100dvh-79px)] min-h-[600px] w-full overflow-hidden">
      <div className="container relative h-full w-full bg-hero bg-[length:auto_100%] bg-center bg-no-repeat lg:bg-right">
        <div className="hero-mask absolute left-0 z-[1] h-[calc(100dvh-79px)] min-h-[600px] w-full opacity-60 sm:hidden"></div>
